...
Write-Output "=> De Lanlords VPN connectie wordt opgezet .."
...
# output status to console
Write-Output "=> De Lanlords routes worden ingesteld .."
Start-Sleep -Seconds 1
...
# output status to console
Write-Output "=> De Lanlords VPN is geconfigureerd. Volg de rest van de stappen op docs.lanlords.nl"
